...
const Resume = ({ className = "" }) => {
  return (
    <div
      className={`flex flex-row mt-4 sm:items-center md:justify-start gap-10 items-center justify-center ${className}`}
    >
      {/* Resume section */}
      <a
        href="https://drive.google.com/uc?export=download&id=1lpcLsaxmMl-dzdN-5bVh7yGQQYwuXt7X"
        target="_blank"
