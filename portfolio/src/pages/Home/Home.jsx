...
const Home = () => {
  return (
    <div
      id="home"
      className="flex sm:flex-row flex-col items-center justify-between px-12 py-8 sm:py-0 mx-auto bg-light dark:bg-dark"
    >
      {/* left section */}
      <div className="left-home sm:w-1/3 w-full h-screen flex items-center justify-center flex-col gap-6">
        <img
          ...
          src={man}
          alt="suraj kr"
          className="sm:w-[320px] w-[250px] rounded-lg border-[1px] border-r-8 border-b-4 border-b-black border-r-black shadow-lg p-3
          dark:border-light"
        />
